    ...
    Inputmask.prototype = {
        ...
        analyseMask: function (mask, opts) {
            ...
            function verifyGroupMarker(lastMatch, isOpenGroup) {
                if (lastMatch && lastMatch.isGroup) {
            ...
            function maskCurrentToken(
                ...
                if (
                    ...
                    (extraCondition === undefined || extraCondition)
                ) {
                    lastMatch =
    ...
    function generateMaskSet(opts, nocache) {
        function generateMask(mask, metadata, opts) {
            if (mask === null || mask === "") {
                ...
                if (
                    Inputmask.prototype.masksCache[mask] === undefined ||
                    nocache === true
                ) {
                    masksetDefinition = {
                        mask: mask,
        ...
        if ($.isArray(opts.mask)) {
            if (opts.mask.length > 1) {
                opts.keepStatic =
                    opts.keepStatic === null ? true : opts.keepStatic;
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function getLastValidPosition(closestTo, strict, validPositions) {
            ...
            for (var posNdx in valids) {
                ...
                if (
                    valids[psNdx] &&
                    (strict || valids[psNdx].match.fn !== null)
                ) {
                    if (psNdx <= closestTo) before = psNdx;
                    if (psNdx >= closestTo) after = psNdx;
                }
            }
            return (before !== -1 && closestTo - before > 1) ||
                after < closestTo
                ? before
                : after;
        }
        ...
        function determineTestTemplate(tests, guessNextBest) {
            ...
            for (var ndx = 0; ndx < testPositions.length; ndx++) {
                ...
                if (
                    testPos.match &&
                    ((opts.greedy &&
                        testPos.match.optionalQuantifier !== true) ||
                        ((testPos.match.optionality === false ||
                            testPos.match.newBlockMarker === false) &&
                            testPos.match.optionalQuantifier !== true)) &&
                    (lvTest.alternation === undefined ||
                    ...
                    if (testPos === pos && match.matches === undefined) {
                        ...
                        if (match.isGroup && quantifierRecurse !== match) {
                            ...
                            for (
                                ...
                                var tokenGroup =
                                    maskToken.matches[
                                        $.inArray(qt, maskToken.matches) - 1
                                    ];
                                match = handleMatch(
                                    tokenGroup,
                                    [qndx].concat(loopNdx),
            ...
            function filterTests(tests) {
                if (opts.keepStatic && pos > 0) {
                    if (
                        ...
                        if (
                            tests[0].match.optionality !== true &&
                            tests[0].match.optionalQuantifier !== true &&
                            tests[0].match.fn === null &&
        ...
        function isValid(pos, c, strict, fromSetValid, fromAlternate) {
                    ...
                    rslt =
                        test.fn != null
                            ...
                            : (c === test.def ||
                              ...
                              test.def !== ""
                            ? { c: test.placeholder || test.def, pos: position }
                            : false;
                    if (rslt !== false) {
                        ...
                        if (rslt.refreshFromBuffer) {
                            ...
                            if (validatedPos !== position) {
                                rslt = $.extend(
                                    rslt,
                                    isValid(validatedPos, elem, true)
                                );
                                return false;
                            }
                        }
            ...
            function setValidPosition(
                ...
                if (
                    ...
                    getMaskSet().validPositions[pos] = $.extend(
                        true,
                        {},
                        validTest
                    );
                    ...
                    for (i = j = pos; i <= lvp; i++) {
                        ...
                        if (t !== undefined) {
                            ...
                            while (
                                ...
                                ((t.match.fn == null &&
                                    vps[i] &&
                                    (vps[i].match.optionalQuantifier === true ||
                                        vps[i].match.optionality === true)) ||
                                    t.match.fn != null)
                            ) {
                                posMatch++;
                                if (
                                    ...
                                    positionsClone[posMatch].match.def ===
                                        t.match.def
                                ) {
                ...
                if ((!strict || fromSetValid === true) && result === false) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            testsFromPos.pop();
                        var staticChar = determineTestTemplate(
                            testsFromPos,
                            true
                        );
                        if (staticChar && staticChar.match.fn === null) {
                            staticChar =
                                staticChar.match.placeholder ||
                                staticChar.match.def;
            ...
            if (
                ...
                result = opts.postValidation(getBuffer(true), result, opts)
                    ? result
                    : false;
            }
        ...
        function checkVal(
            ...
            function isTemplateMatch() {
                var isMatch = false;
                var charCodeNdx = getBufferTemplate()
            ...
            if (writeOut) {
                ...
                if (
                    ...
                    if (initiatingEvent && result === false)
                    ...
                    if (
                        ...
                        caretPos =
                            opts.numericInput && result.caret === undefined
        ...
        function unmaskedvalue(input) {
            ...
            if ($.isFunction(opts.onUnMask)) {
                ...
                unmaskedValue =
                    opts.onUnMask(bufferValue, unmaskedValue, opts) ||
                    unmaskedValue;
            }
        ...
        function caret(input, begin, end, notranslate) {
            ...
            if (typeof begin === "number") {
                ...
                if (!mobile && opts.insertMode === false && begin === end)
                    end++;
        ...
        function handleRemove(input, k, pos, strict) {
            ...
            if (
                k === Inputmask.keyCode.BACKSPACE &&
                (pos.end - pos.begin < 1 || opts.insertMode === false)
            ) {
                                    ...
                                    if (clickPosition < lastPosition) {
                                        caret(
                                            ...
                                            !isMask(clickPosition) &&
                                                !isMask(clickPosition - 1)
                                                ? seekNext(clickPosition)
                                                : clickPosition
                                        );
                                    } else {
                                        var placeholder =
                                            getPlaceholder(lastPosition);
                                        if (
                                            (placeholder !== "" &&
                                                getBuffer()[lastPosition] !==
                                                    placeholder &&
                                                getTest(lastPosition).match
                                                    .optionalQuantifier !==
                                                    true) ||
                                            (!isMask(lastPosition) &&
                                                getTest(lastPosition).match
